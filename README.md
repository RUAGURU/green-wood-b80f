...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/green-wood-b80f
```

A live public deployment of this template is available at [https://green-wood-b80f.templates.workers.dev](https://green-wood-b80f.templates.workers.dev)
